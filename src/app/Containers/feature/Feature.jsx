...
const  Feature = () => {
  ...
  return (
    <div className='gpt4_feature  section_padding '>
      <div className='gpt4_feature-heading'>
      <h1 className='gradient__text'>The Future is Now and You Just Need To Realize It. Step into Future Today & Make it Happen.</h1>
      <p>Request Early Access to Get Started</p>  
      </div>
      <div className='gpt4_feature_container'>
        {
          featureData.map((elem,index)=>{
          return  <Featuares title={elem.title} text={elem.text} key={elem.title+index}/>
          })
        }
      </div>
    </div>
